...
export type FieldType = "text" | "secret" | "model-roles";
...
// Codex：顶层 model_provider / model / wire_api
const codexSpec: HarnessFormSpec = {
  ...
  fields: [
    ...
    { key: "model", label: "模型", type: "text", placeholder: "gpt-5.6-sol" },
...
const geminiSpec: HarnessFormSpec = {
  ...
  fields: [
    ...
    { key: "GEMINI_MODEL", label: "模型", type: "text", placeholder: "gemini-2.5-pro" },
  ],
  toSettings(form) {
    const env: Record<string, string> = {};

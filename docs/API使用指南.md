...
console.log(result);
// { success: true, message: "网关已启动", bind_address: "127.0.0.1:2013" }
```
...
// { success: true, message: "网关已重启", bind_address: "127.0.0.1:2013" }
```
...
curl http://127.0.0.1:2013/v1/chat/completions \
...
curl http://127.0.0.1:2013/v1/messages \
  -H "Content-Type: application/json" \
